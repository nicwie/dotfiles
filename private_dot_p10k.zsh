# Generated by Powerlevel10k configuration wizard on 2025-05-18 at 23:57 CEST.
...
() {
  ...
  get_taskwarrior_active_task() {
    if ! command -v jq &> /dev/null; then
      return "" # Or nothing
    fi
    local task_info
    task_info=$(TASK_PROMPT_CALL=1 task +ACTIVE export | jq -e -r '.[0] | if .id == null then empty else "\(.id): \(.description)" end')
    echo "${task_info}"
    return 0
  }
  ...
  typeset -g POWERLEVEL9K_MY_ACTIVE_TASKWARRIOR_VISUAL_IDENTIFIER_EXPANSION=''
  # \udb83\udd04
